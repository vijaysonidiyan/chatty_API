...
class chatScreenManagementModel extends ModelBase {
    constructor() {
        super(CONFIG.DB.MONGO.DB_NAME, "chatScreenManagement", {
            userId: { type: Object, allowNullEmpty: false },
            chatWith: { type: Object, allowNullEmpty: true },
            status: {
                type: Number,
                allowNullEmpty: false,
                enum: { 1: "Main Screen", 2: "On User Chat Screen", 3: "Not On Chat Scrren" }
            },
...
module.exports = chatScreenManagementModel;