        ...
        async.waterfall([
            function (cb) {
                // convert video to mp4 if required
                    ...
                    console.log("videosssssssssssssssssssssssssssssss");
                    console.log("filesArr.lengthfilesArr.length",filesArr.length);

                    let total = 0
                    for (let filesArrKey in filesArr) {
                        let files = filesArr[filesArrKey];
                        total = total+1
                        console.log("totalllllllllllllllllllllllll",total);
                        for (let filesKey in files) {
                            let file = files[filesKey];
                            console.log("fileeeeeeeeeeeeeeeeeeeeeee", file);
                            console.log("fileeeeeeeeeeeeeeeeeeeeeee", req.files.videos.length);
...
mediaCtrl.mediaMasterSavenew = (req, res) => {
    const response = new HttpRespose();
            ...
            if (err) {
                ...
                for (let filesArrKey in filesArr) {
                    ...
                    for (let filesKey in files) {
                        ...
                        if (file.fieldname === "videos") {
                            let totalVideo = data.media.videos.files.length;
                            console.log("totalVideototalVideototalVideo",totalVideo);
                            vIndex = vIndex+1
